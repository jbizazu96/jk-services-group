        ...
        <>
          ...
          <section className="relative w-full">
            <div className="relative h-[90vh] min-h-[650px] w-full overflow-hidden">
              <Image src="https://images.unsplash.com/photo-1445205170230-053b83016050?w=1400&h=900&fit=crop" alt="Ketany Style Fashion"  className="object-cover scale-105" priority />
